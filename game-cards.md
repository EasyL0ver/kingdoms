...
One per deck. Placed next to their draw pile at setup. Defines how activating the deck (drawing from it) works.
...
> Violence, ambition, raw power, societal sentiment. The primal human element — anger, passion, desire, fear. The uncontrollable voice of the people that every civilisation must contend with. Largest deck in the game.
...
🤖 Save until Mob cards are planted in the target Domain. Avoid Domains with Militia or Eldership.
...
🤖 Strong early game. Stack Pastures to raise the shared limit.
...
🤖 Position Mob cards first, then Rite → targeted Brawl.
...
> Competes for [Allegiance] slot with Eldership.

🤖 Repeatable Incite — move Mob every turn. Best with cultural allies.
...
🤖 Dump it to opponents via Incite/Chiefdom or use in your domain to draw more claw
...
🤖 Skip if no Sword deck in the game. Needs Coin cards to fuel.
...
🤖 Check Season before activating — worthless with 0 Land, amazing with 2+.
...
🤖 Best when many players share your culture. Conditional Brawl defense.
...
🤖 Choose Rite when you have responders, scry when fishing for Spiritual cards. Cornerstone card.
...
> Only way to access the Candle deck.

🤖 Worth the Coin cost if Candle cards are powerful. Build Coin economy first.
...
🤖 Recover key cards from discard. Sacrifice cost is real — pick carefully.
...
🤖 Dig for specific Tree cards. Only sacrifice Forage if you find something great.
...
> You can't access Wheat by default — this is a gateway.

🤖 Needs 2+ Nature. Pasture + any other Nature card enables this.
...
> Alternative Wheat gateway — needs Harvest in discard, not Nature cards.
...
🤖 Diplomacy-dependent — less reliable than other gateways. Situational.
...
```
🕯️  (UNNAMED WORSHIP CARD)
[Spiritual]
(TBD — exclusive to organized religion)
```
...
*(No cards designed yet)*

---

## 🚩 Banner Deck Cards

> Professional armies, military strategy, organised warfare. From feudal knights to imperial legions.
...
> Court intrigue, political authority, patronage. Power through proximity to the throne.
...
> Art, drama, legacy, soft power. Cultural dominance — the empire remembered by history.
